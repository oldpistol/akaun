...
<body>
    <div class="container">
        ...
        <div class="info-section">
            ...
            <div class="quotation-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $quotation->issued_at->format('M d, Y') }}</span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $quotation->accepted_at->format('M d, Y') }}</span>
                </div>
                @endif
                @if($quotation->discount_rate > 0)
                <div class="detail-row">
                    <span class="detail-label">Discount:</span>
                    <span class="detail-value">{{ number_format($quotation->discount_rate, 1) }}%</span>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="validity-notice">
            <strong>Important:</strong> This quotation is valid until {{ $quotation->valid_until->format('F d, Y') }}.
        </div>
        @endif
        ...
        <div class="totals-section">
            ...
            <div class="total-row">
                ...
                <span class="total-value">${{ number_format($quotation->tax_total, 2) }}</span>
            </div>
            @if($quotation->discount_rate > 0)
            <div class="total-row">
                <span class="total-label">Discount ({{ number_format($quotation->discount_rate, 1) }}%):</span>
        ...
        {{-- Footer --}}
        <div class="footer">
            <div class="footer-line">Thank you for considering our services!</div>
            <div class="footer-line">For questions about this quotation, please contact us at info@yourcompany.com</div>
        </div>
    </div>
</body>
</html>
