...
<head>
    ...
    <title>Receipt for Invoice {{ $invoice->invoice_number }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="payment-info-box">
            ...
            <div class="payment-info-row">
                ...
                <span class="payment-info-value">{{ $invoice->paid_at->format('F d, Y') }}</span>
            </div>
            <div class="payment-info-row">
                <span class="payment-info-label">Payment Method:</span>
                <span class="payment-info-value">{{ $invoice->paymentMethod?->name ?? 'N/A' }}</span>
            </div>
            @if($invoice->payment_reference)
            <div class="payment-info-row">
                <span class="payment-info-label">Transaction Reference:</span>
                <span class="payment-info-value">{{ $invoice->payment_reference }}</span>
            </div>
            @endif
            <div class="payment-info-row">
                <span class="payment-info-label">Amount Paid:</span>
                <span class="payment-info-value">${{ number_format($invoice->total, 2) }}</span>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <div class="footer-line">This receipt confirms that payment has been received in full.</div>
            <div class="footer-line">For questions about this receipt, please contact us at info@yourcompany.com</div>
        </div>
    </div>
</body>
</html>
