...
describe('InvoiceItem Creation', function () {
    it('creates an invoice item with valid data', function () {
    ...
    it('creates an invoice item with zero tax rate by default', function () {
        $item = InvoiceItem::create(
            invoiceId: 1,
    ...
    it('creates an invoice item with explicit zero tax rate', function () {
        $item = InvoiceItem::create(
            invoiceId: 1,
...
describe('InvoiceItem Calculations', function () {
...
describe('InvoiceItem Mutations', function () {
